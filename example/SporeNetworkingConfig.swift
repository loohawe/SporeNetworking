...
extension MogoAPIRequest {
    ...
    func intercept(object: Any, urlResponse: HTTPURLResponse) throws -> Any {
        ...
        return MogoResponse(statusCode: status, contentJSON: contentJSON, urlResponse: urlResponse)
    }
}
...
//// Will be set to HTTPBody
//public struct MGBodyParameters: BodyParameters {
//    
...
//        if let param: [String : Any] = request.parameters, !param.isEmpty {
//            
//            if !request.method.prefersQueryParameters {
//                var bodyData: Data
//                do {
//                    bodyData = try JSONSerialization.data(withJSONObject: param, options: [])
//                } catch {
//                    throw MogoError.RequestError.notConvertParametersToJSON(param)
//                }
//                
